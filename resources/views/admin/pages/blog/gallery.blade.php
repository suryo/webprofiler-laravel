...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ url('/') }}/admin/blog/posts" class="css3animate btn btn-primary text-white">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($gallery_images as $gallery_image)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form class="d-inline-block" action="{{url('/admin/blog/gallery')}}/{{ $gallery_image->id }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center">
                                                                        ...
                                                                        <input type="hidden" name="post_id" value="{{ $gallery_image->blog_id }}"/>
                                                                    </div>
