...
window.Modernizr = function(a, b, c) {
        ...
        !B(x, "undefined") && !B(x.call, "undefined") ? y = function(a, b) { return x.call(a, b) } : y = function(a, b) { return b in a && B(a.constructor.prototype[b], "undefined") }, Function.prototype.bind || (Function.prototype.bind = function(b) {
            ...
            return e
        }), q.touch = function() { var c; return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : w(["@media (", m.join("touch-enabled),("), h, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(a) { c = a.offsetTop === 9 }), c }, q.cssanimations = function() { return F("animationName") }, q.csstransitions = function() { return F("transition") };
        ...
        return e.addTest = function(a, b) {
            ...
            function(a, b) {
                ...
                function q(a) { a || (a = b); var c = m(a); return r.shivCSS && !f && !c.hasCSS && (c.hasCSS = !!k(a, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:pageWrapper}mark{background:#FF0;color:#000}")), j || p(a, c), a }
                var c = a.html5 || {},
...
var PageTransitions = (function() {
    ...
    function pageOverflows($pageTrigger) {
        var overflow = parseInt($pageTrigger.data('overflow'));
        if (overflow == 0) {
    ...
    function pageNavColors($pageTrigger) {
        ...
        $('#mainNav, .pt-trigger-container, .mobile-nav').removeClass('light-scheme').removeClass('dark-scheme').addClass(style);
    }
